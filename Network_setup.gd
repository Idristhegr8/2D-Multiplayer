...
func instance_player(id) -> void:
	var player_instance = Global.instance_node_at_location(player, Persistent_nodes, get_node("Spawn_locations/" + String(current_spawn_location_instance_number)).global_position)
...
sync func switch_to_game() -> void:
	for child in Persistent_nodes.get_children():
		if child.is_in_group("Player"):
			child.bullet_label.get_parent().show()
